      ...
      <section className="relative text-white py-36 px-4 overflow-hidden pt-32">
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <p className="font-sans text-sm font-semibold uppercase tracking-widest text-[#D4AF37] mb-4">Case Study</p>
            ...
            >
              <ContentBlock
                ...
                image={{
                  ...
                  objectFit: "object-contain object-left max-w-lg !w-auto",
                  height: "h-auto",
                }}
    ...
    <Wrapper id={id} className="scroll-mt-32">
      ...
      {graphicProcess.length > 0 && (
        <div className="mt-8 relative">
          <div
            className="absolute left-8 top-16 w-0.5 bg-gradient-to-b from-[#D4AF37] to-[#D4AF37]/30 hidden md:block"
            style={{ height: `${(graphicProcess.length - 1) * 8 + 4}rem` }}
          ></div>
            ...
            {graphicProcess.map((step, i) => (
              <div key={i} className="relative flex items-start gap-6">
                ...
                {i < graphicProcess.length - 1 && (
                  <div className="absolute left-8 top-20 w-0.5 h-8 bg-[#D4AF37]/50 hidden md:block"></div>
                )}
              </div>
            ))}
          </div>
